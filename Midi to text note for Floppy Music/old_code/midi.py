...
for i in mid.tracks:
	...
	for e in i:
		try:
			if e.time/128 != 0:
				print "NOTE_%s, %s," % (notes_number[e.note].replace("#", "S"), e.time/128)			
			#print "NOTE_%s, %s," % (notes_number[e.note], e.time/128)
		except:
			t = 0

#print "NOTE_%s, %s" % (notes_number[mid.tracks[1][4].note], mid.tracks[1][4].time)
